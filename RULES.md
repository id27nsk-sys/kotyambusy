...
- **KUS_ATTACK_STRICT**: Для Баси (b). Рандомный Кусь (9-19) с красным свечением.
...
- **IMPACT_DYNAMICS_STRICT**: Эффект «Куся» молниеносен (500ms) с инверсией и зумом.
- **SOFT_TRANSITION_STRICT**: Мягкий визуальный переход (fade) 0.3с для циклов.
- **WEBP_MIGRATION_STRICT**: Проект использует формат .webp для всех фото героев.
- **WORKSHOP_AUTO_NAMING_STRICT**: Мастерская автоматически определяет имя следующего файла.
...
- `/images/cats/actions/KUS.jpg` — Фото КУСЬ!.
