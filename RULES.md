...
- **DOM_LEAK_TEST**: Запрещено накопление мусорных узлов. Все временные элементы должны удаляться через remove().
...
- **GLOW_CELEBRATION**: При достижении количества поглаживаний, кратного 30, вокруг круга героя активируется временный эффект золотого сияния (glow).
