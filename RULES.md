...
- **HAPTIC_ATTACK_STRICT**: В момент срабатывания «Куся» на мобильных устройствах активируется вибрация (паттерн: 100ms удар, 50ms пауза, 200ms мощный удар).
- **HERO_SCALE_STRICT**: Размер круга героя должен занимать максимально возможное пространство вьюпорта без вытеснения кнопок управления. Лимиты: 280px (Standard), 200px (Micro-Mobile).
