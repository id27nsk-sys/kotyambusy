const KOTYAMBUS_CORE = {
    basya: { name: "БАСЯ", mult: 1, bite: 0.3, patience: 5, img: "images/b01.jpg" },
    saveliy: { name: "САВЕЛИЙ", mult: 2, bite: 0.1, patience: 15, img: "images/s01.jpg" }
};
